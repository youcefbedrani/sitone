  ...
  return (
    <section className="cta">
      <div className="container cta-inner">
        <h2>لا تؤجل مشروعك — كل يوم تأخير هو فرصة ضائعة</h2>
        <p>احجز استشارتك المجانية اليوم، وابدأ رحلة تحويل فكرتك إلى واقع رقمي يحقق لك النتائج.</p>
        <a href={WHATSAPP_LINK('مرحباً، أريد أبدأ مشروعي مع OnTime Digital Solutions')} target="_blank" rel="noopener" className="btn btn-primary btn-lg">
