...
export default function StickyCTA() {
  ...
  return (
    <div className={`sticky-cta${visible ? ' visible' : ''}`} id="stickyCta">
      <a href={WHATSAPP_LINK('مرحباً، أريد استشارة مجانية')} target="_blank" rel="noopener" className="btn btn-primary sticky-cta-btn">
